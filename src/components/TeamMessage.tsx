...
const MessageTeamWithContext = (props: MessageTeamWithContextProps) => {
	const {
		clearEditingState,
		editing,
		getMessageActions,
			...
			<div
				...
				<div className='str-chat__message-team-group'>
					...
					<div
						...
						{message.text && (
							<div
								className={clsx("str-chat__message-team-text", {
...
const TeamMessage = (props: MessageUIComponentProps<StreamChatType>) => {
	...
	const { isReactionEnabled, onReactionListClick, showDetailedReactions } =
